...
bact_matrix_rMeans<-rowMeans(xbact_matrix[,-c(22,23)])
bact_matrix_rSds<-rowSds(xbact_matrix[,-c(22,23)])
bact_matrix_zscores<-((xbact_matrix[,-c(22,23)]-bact_matrix_rMeans)/bact_matrix_rSds)


OTUVars<-sort(rowVars(xbact_matrix[,-c(22,23)],useNames = T),decreasing = T)
